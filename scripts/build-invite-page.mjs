...
let html = fs.readFileSync(path.join(root, "tmp-invite-297.html"), "utf8");
...
html = html.replace(
  /<link rel="canonical" href="https:\/\/hraver\.am\/invite\/297">/,
  '<link rel="canonical" href="/invite/297">',
);

const out = path.join(root, "public/invite/297/index.html");
